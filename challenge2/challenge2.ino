...
displayscreen();
//Serial.begin(9600);
myservo.attach(9); //Servo motor connection to pin 9
...
{
//display a * for every key pressed to encrypt the code 
lcd.print("*");
}
//Compares entered code with the password=1111 
if (code==password[currentposition])
{
++currentposition;
if(currentposition==4)
{
//calls function to unlock the door 
unlockdoor();
currentposition=0;
}
}
...
//--------------Function 5 - Count down before closing door again------------------//
void counterbeep()
{
delay(1200);
